...
export const agentAdjacentNotes: Record<string, string> = {
  ...
  "sd-jwt-vc":
    "When this matters for agents: likely credential format if you bind an agent to an organization with selective disclosure (show role, hide home address). IETF Last Call ended 15 September 2026; IESG is Waiting for AD Go-Ahead on draft-19 — not an RFC yet. Not an OAuth access token.",
